...
- 提供常用營養品收藏功能，會員可將常用品項加入收藏清單，方便快速選取常用營養品
- 營養品可以使用不同單位快速比較和試算
- 可以手動加入自己常用的營養品
...
- **加入營養品圖片**  
  ...
  未來陸續加入營養品圖片，讓使用者在選擇產品時能更直覺地確認品項，降低選錯產品的風險。

- **營養品標籤**  
  為營養品加上不同類型的標籤（例如：糖尿病、腎臟病、高蛋白、單素等），使用者可透過標籤快速篩選符合特定疾病或需求的營養品，提升搜尋與選擇的效率。

- **產品比較與 PDF 匯出**  
  支援多項營養品並列比較，並可將營養配置結果匯出為 PDF，方便營養師快速產出建議報告。
