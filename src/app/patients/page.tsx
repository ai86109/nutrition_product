...
export default function PatientsPage() {
  ...
  return (
    <>
      <Navigation />
      <main className="max-w-7xl mx-auto px-4 py-6 flex flex-col gap-4 h-[calc(100vh-64px)]">
                  ...
                  {filteredPatients.map(({ patient: p, snapshots: ss }) => {
                    ...
                    return (
                      <PatientListItem
                        ...
                        canMoveDown={
                          !isFiltered && fullIdx < patients.length - 1
                        }
                  ...
                  {selectedPatientSnapshots.length === 0 ? (
                    ...
                    selectedPatientSnapshots.map((s) => (
                      <SnapshotListItem
                        ...
                        onSelect={() => setSelectedSnapshotId(s.id)}
                        onChanged={reload}
                      />
                    ))
                  )}
